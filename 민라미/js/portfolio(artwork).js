$(function () {
  ...
  $(".art_desc button, .art_img").click(function () {
    $(".mySwiper, .mySwiper2, .mySwiper3").animate({ scrollTop: "963" }, 1000);
  });
  ...
  $(".swiper-button-next, .swiper-button-prev").click(function () {
    $(".mySwiper, .mySwiper2, .mySwiper3").scrollTop("0");
  });
  ...
  $(".back_to_top_button, .art_subimg span").click(function () {
    $(".mySwiper, .mySwiper2, .mySwiper3").animate({ scrollTop: back }, 1000);
  });
